  ...
  return (
    <section>
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
        {skills.map((s) => {
          const cost =
            typeof s.costFor === "function"
              ? s.costFor(s.level)
              : 250 * s.level * s.level;

          const bonus =
            typeof s.bonusLabel === "function"
              ? s.bonusLabel(s.level)
              : `Lv ${s.level}`;
              ...
              <div className="relative flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="shrink-0 rounded-md border border-accent/40 bg-accent/25 px-1.5 text-[10px] font-black text-accent">
                      LV {s.level}
                    </span>
                  </div>
                  ...
                  <p className="truncate text-[11px] font-bold text-gold">
                    {bonus}
                  </p>
                </div>
